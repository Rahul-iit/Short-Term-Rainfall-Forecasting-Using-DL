...
Original file is located at
    https://colab.research.google.com/drive/1KQsuJb5jyhAJwK7ccTOjs_Tp0AXMqMiy
...
# %cd /content/
!git clone https://github.com/Rahul-iit/Short-Term-Rainfall-Forecasting-Using-DL.git
# %cd /content/Short-Term-Rainfall-Forecasting-Using-DL
